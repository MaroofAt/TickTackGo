class UpdateWorkspaceModel {
  ...
  factory UpdateWorkspaceModel.onSuccess(Map<String, dynamic> json) =>
      UpdateWorkspaceModel(
        id: json["id"],
        title: json["title"],
  ...
  factory UpdateWorkspaceModel.onError(Map<String, dynamic> json) =>
      UpdateWorkspaceModel(
        id: 0,
        title: '',
        description: '',
  ...
  factory UpdateWorkspaceModel.error(String errorMessage) =>
      UpdateWorkspaceModel(
        id: 0,
        title: '',
        description: '',
