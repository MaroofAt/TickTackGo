...
class FetchWorkspacesModel {
  ...
  factory FetchWorkspacesModel.onSuccess(Map<String, dynamic> json) => FetchWorkspacesModel(
    id: json["id"],
    title: json["title"],
  ...
  factory FetchWorkspacesModel.onError(Map<String, dynamic> json) => FetchWorkspacesModel(
    id: json["id"]??0,
    title: json["title"]??'',
    description: json["description"]??'',
    image: json["image"],
  ...
  factory FetchWorkspacesModel.error(String errorMessage) => FetchWorkspacesModel(
    id: 0,
    title: '',
    description: '',
    image: null,
