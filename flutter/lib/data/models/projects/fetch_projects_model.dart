class FetchProjectsModel {
  ...
  factory FetchProjectsModel.onSuccess(Map<String, dynamic> json) =>
      FetchProjectsModel(
        id: json["id"],
        title: json["title"],
        color: json["color"],
  ...
  factory FetchProjectsModel.onError(Map<String, dynamic> json) =>
      FetchProjectsModel(
        id: json["id"] ?? 0,
        title: json["title"] ?? '',
        color: json["color"] ?? '',
        ...
        createdAt: null,
        updatedAt: null,
        errorMessage: json["message"] ?? json["detail"],
      );

  factory FetchProjectsModel.error(String errorMessage) =>
      FetchProjectsModel(
        id: 0,
        title: '',
        color: '',
