class CreateProjectModel {
  ...
  factory CreateProjectModel.onSuccess(Map<String, dynamic> json) =>
      CreateProjectModel(
        id: json["id"],
        title: json["title"],
        color: json["color"],
  ...
  factory CreateProjectModel.onError(Map<String, dynamic> json) =>
      CreateProjectModel(
        id: json["id"] ?? 0,
        title: json["title"] ?? '',
        color: json["color"] ?? '',
  ...
  factory CreateProjectModel.error(String errorMessage) => CreateProjectModel(
        id: 0,
        title: '',
        color: '',
        ended: false,
