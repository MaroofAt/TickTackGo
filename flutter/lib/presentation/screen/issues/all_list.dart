        ...
        return Stack(
          children: [
            Card(
              ...
              child: ListTile(
                title: Text(issue.title, style: const TextStyle(color: white)),
                trailing: issue.solved != true
                    ? const Icon(Icons.close, color: ampleOrange)
                    : const Icon(Icons.check, color: ampleOrange),
                onTap: () async {
