...
class TasksGanttChart extends StatelessWidget {
  final List<FetchTasksModel> tasks;
  const TasksGanttChart({super.key, required this.tasks});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold( backgroundColor: primaryColor,
      appBar: AppBar(backgroundColor: primaryColor,leading:IconButton( onPressed: () => popScreen(context), icon: Icon(Icons.arrow_back_sharp,color:white )),

          title: Center(child: const Text('Gantt Chart',style: TextStyle(color: white,fontSize: 20,fontFamily: 'PTSerif')))),
      body: valid.isEmpty
