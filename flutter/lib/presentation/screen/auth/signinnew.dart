  ...
  Widget build(BuildContext context) {
    ...
    style: TextStyle(color: Colors.red, fontSize: 12),
        ...
        , Container(
              ...
              decoration:BoxDecoration(color:parrot_green,borderRadius: BorderRadius.all(Radius.circular(10))),width: width(context)*0.9,
...
Container(child: Icon(Icons.key_sharp,color: lightGrey),margin:EdgeInsets.only(left: width(context)*0.354
            ...
            Container(
              ...
              padding: EdgeInsets.only(left: 50),
                ...
                decoration:BoxDecoration(color:Ample_orang.withOpacity(0.5),borderRadius: BorderRadius.all(Radius.circular(10) )),width: width(context)*0.9,
